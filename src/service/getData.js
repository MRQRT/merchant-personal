...
export const addRecycleOrder = (rOrder,contact,telephone,address,isCash,idPic) => fetch(gold + '/v3/recycleOrder/addRecycleOrder',{'rOrder':rOrder,'contact':contact,'telephone':telephone,'address':address,'isCash':isCash,'idPic':idPic},'post')
