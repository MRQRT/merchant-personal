...
export const quickLogin = (telephone,code) => fetch('/v3/member/quickLogin',{'telephone':telephone,'code':code},'post');
export const quickLogin1 = (telephone,code,source) => fetch('/v3/member/quickLogin',{'telephone':telephone,'code':code,'source':source},'post');
export const quickLogin2 = (telephone,code,invitedBy) => fetch('/v3/member/quickLogin',{'telephone':telephone,'code':code,'invitedBy':invitedBy},'post');
export const quickLogin3 = (telephone,code,invitedBy,source) => fetch('/v3/member/quickLogin',{'telephone':telephone,'code':code,'invitedBy':invitedBy,'source':source},'post');
...
export const demandBuyOrder = (amount,weight,maxPrice,userCouponId) => fetch('/v3/order/demandBuyOrder',{'amount':amount,'weight':weight,'maxPrice':maxPrice,'userCouponId':userCouponId},'post')

/**
 * 创建活期金卖出订单
 */

export const demandSellOrder = (weight,minPrice) => fetch('/v3/order/demandSellOrder',{'weight':weight,'minPrice':minPrice},'post')
